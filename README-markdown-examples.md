...
### Footnotes
<!-- funciona en Github que agrega las notas automágicamente al final del documento -->
...
<!-- Escriba los caracteres con espacio frente al elemento de la lista anidada hasta que el carácter del marcador de lista (- o *) se encuentre directamente debajo del primer carácter del texto en el elemento que se encuentra debajo. -->
...
<details>
  <summary>Contenido Colapsable en un README</summary>
